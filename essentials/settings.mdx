...
<ResponseField name="api" type="API">
  Configuration for API settings. Learn more in the [Mintlify API playground guides](https://www.mintlify.com/docs/api-playground/overview).
    ...
    <ResponseField name="playground" type="Playground">
      ...
      <Expandable title="Playground">
        <ResponseField name="mode" default="show" type='"show" | "simple" | "hide"'>
          ...
          Learn more in the [Mintlify playground guides](https://www.mintlify.com/docs/api-playground/overview).
        </ResponseField>
      </Expandable>
    </ResponseField>
