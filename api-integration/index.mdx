...
The **API Integration** method provides complete control over your ramp flow.
Instead of embedding our hosted widget, your server communicates directly with our endpoints which is perfect for building a fully customized checkout experience.
...
**Description:**
Returns a list of all supported cryptocurrencies and their networks.
...
**Description:**
Lists available fiat currencies for transactions.
...
**Description:**
Returns all supported payment methods for buying or selling crypto.
...
**Description:**
Fetches exchange rate quotes from all supported providers.
...
**Description:**
Creates a new transaction and returns a checkout URL for the user to complete payment.
...
| `type`            | string | `"BUY"`               | Transaction type (`BUY` or `SELL`). |
| `wallet_address`  | string | `"bc1qxyz..."`        | Recipient’s crypto wallet address.  |
...
**Description:**
Receive updates for transaction status changes.
