...
Webhooks allow your application to receive **real-time notifications** from our system when a transaction succeeds or fails.
...
3. **Select events** you want to subscribe to (`transaction.success` and/or `transaction.failed`).
